          ...
          <div nz-row>
            ...
            <nz-form-item nz-col nzSpan="12">
              ...
              <nz-form-control
                ...
                [nzXs]="24"
              >
                <nz-input-group [nzSuffixIcon]="'user'" class=" tw-w-[90%]">
                  <input
            ...
            <nz-form-item nz-col nzSpan="12">
              <nz-form-label nzRequired class="tw-font-bold tw-text-xl"
                >Tên</nz-form-label
              >
              <nz-form-control nzErrorTip="Nhập tên" [nzSm]="24" [nzXs]="24">
                <nz-input-group [nzSuffixIcon]="'user'" class=" tw-w-[90%]">
                  <input
                    type="text"
                    nz-input
            ...
            <nz-form-item nz-col nzSpan="12">
              ...
              <nz-form-control nzErrorTip="Nhập địa chỉ">
                <nz-input-group [nzSuffixIcon]="'audit'" class=" tw-w-[90%]">
                  <input
                    type="text"
            ...
            <nz-form-item nz-col nzSpan="12">
              ...
              <nz-form-control [nzErrorTip]="emailErrorTpl">
                <nz-input-group [nzSuffixIcon]="'mail'" class=" tw-w-[90%]">
                  <input
                    type="text"
            ...
            <nz-form-item nz-col nzSpan="12">
              ...
              <nz-form-control [nzErrorTip]="phoneErrorTpl">
                <nz-input-group [nzSuffixIcon]="'phone'" class=" tw-w-[90%]">
                  <input
                    type="text"
                    appOnlyNumber
            ...
            <nz-form-item nz-col nzSpan="12">
              ...
              <nz-form-control [nzErrorTip]="iErrorTpl">
                <nz-input-group [nzSuffixIcon]="'book'" class=" tw-w-[90%]">
                  <input
                    type="text"
